...
namespace DotNetShipping.ShippingProviders
{
    ...
    {        
        ...
        public FedExProvider()
        {
            ...
            Init(appSettings["FedExKey"], appSettings["FedExPassword"], appSettings["FedExAccountNumber"], appSettings["FedExMeterNumber"], true,_residental);
        }
        ...
        public FedExProvider(string key, string password, string accountNumber, string meterNumber, bool useProduction, bool res)
        {
            Init(key, password, accountNumber, meterNumber, useProduction, res);
        }

        private void Init(string key, string password, string accountNumber, string meterNumber, bool useProduction, bool res)
        {
            Name = "FedEx";
            _key = key;
            _password = password;
