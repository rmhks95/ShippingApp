...
namespace DotNetShipping.SampleApp
{
    internal class Program
    {
        ...
        public static void Begin() {
            ...
            string[] parts = new string[pn_in.Count*2];
            ...
            if (unknownWeight != 0) { packages.Add(new Package(0, 0, 0, unknownWeight, 50)); }

            Start();
            
        }

        public static int unknownWeight = 0;
        ...
        private static void Part_Finder(string pn)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    unknownWeight += Convert.ToInt32(dr["item_weight"])+1;
                    return;
                }
        ...
        private static void Start()
        {
            ...
            {
                if (rate.Name != "FedEx Priority Overnight" && rate.Name != "FedEx 2nd Day")
                {
